...
namespace DateTimeLab
{
    public class DateTimeLabCode
    {
        ...
        {
            DateTime shor = new DateTime(year, month, day);
            string temp = shor.ToString("M/d/yy");
            return temp;
        }
        ...
        {
            DateTime store = DateTime.Parse(date);
            string temp = store.ToString("MM.dd.yyyy hh:mm tt");
            return temp;
        }
        ...
        public string GetDateInSixMonths(string date)
        {
            ...
            return temp.ToString("MMMM d, yyyy");
        }
