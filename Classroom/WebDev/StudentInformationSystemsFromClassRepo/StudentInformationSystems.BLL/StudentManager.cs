...
namespace StudentInformationSystems.BLL
{
    public class StudentManager
    {
        ...
        public Response<Student> AddStudent(Student student)
        {
            ...
            try
            {
                if(string.IsNullOrEmpty(student.Name)) throw new Exception("Student Name is Required");
                if(student.GPA < 0 && student.GPA > 4) throw new Exception("Student GPA is Required to be between 0-4");
